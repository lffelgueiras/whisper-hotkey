...
- [ ] **Step 1: Re-purpose the "main" window**
...
- [ ] **Step 2: Install shadcn components used in Settings**

```bash
pnpm dlx shadcn@latest add tabs button input switch select label
```

- [ ] **Step 3: Settings shell with tabs**
...
- [ ] **Step 4: Tray menu — open Settings**
...
- [ ] **Step 5: Commit (placeholder tabs)**
...
- [ ] **Step 3: HotkeyCapture component**
